...
const videos = [
  ...
  },
  {
    ...
    aspectRatio: "177.78%"  // Changed to match 9:16
  },
  {
    id: "1041570666",
        ...
        {videos.map((video, index) => (
          ...
          >
            <div style={{ padding: `${video.aspectRatio} 0 0 0`, position: 'relative' }}>
              <iframe
                src={`https://player.vimeo.com/video/${video.id}?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479&background=1`}
                style={{
                  position: 'absolute',
                  top: 0,
                  left: 0,
